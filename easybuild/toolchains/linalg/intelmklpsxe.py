...
class IntelMKLPSXE(LinAlg):
    ...
    LAPACK_MODULE_NAME = BLAS_MODULE_NAME
    LAPACK_IS_BLAS = True
    LAPACK_FAMILY = TC_CONSTANT_INTELMKL

    BLACS_MODULE_NAME = BLAS_MODULE_NAME
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(IntelMKLPSXE, self).__init__(*args, **kwargs)
    ...
    def set_variables(self):
        ...
        mkl_version = self.get_software_version(self.blas_environment_name)[0]
        ...
        super(IntelMKLPSXE, self).set_variables()
    ...
    def _set_blas_variables(self):
        ...
        super(IntelMKLPSXE, self)._set_blas_variables()
    ...
    def _set_blacs_variables(self):
        ...
        super(IntelMKLPSXE, self)._set_blacs_variables()
    ...
    def _set_scalapack_variables(self):
        ...
        super(IntelMKLPSXE, self)._set_scalapack_variables()
