...
from easybuild.toolchains.compiler.inteliccifortpsxe import IntelIccIfortPSXE
from easybuild.toolchains.mpi.intelmpipsxe           import IntelMPIPSXE
from easybuild.toolchains.fft.intelfftwpsxe          import IntelFFTWPSXE
from easybuild.toolchains.linalg.intelmklpsxe        import IntelMKLPSXE


class IntelPSXE(IntelIccIfortPSXE, IntelMPIPSXE, IntelMKLPSXE, IntelFFTWPSXE):
    """
